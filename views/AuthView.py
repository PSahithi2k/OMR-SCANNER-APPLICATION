...
class AuthView:
    ...
    def load(self):
        self.window = Tk()
        self.window.title("OMR-SCANNER-APP")
    ...
    def login(self, login_frame):
        ...
        login_button = Button(window, text='Login',  command= lambda: self.login_control(username_entry.get(), password_entry.get()), padx=5, pady=5)
